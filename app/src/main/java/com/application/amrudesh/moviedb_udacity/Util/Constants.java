...
public class Constants {
    ...
    public static final String popular_url ="https://api.themoviedb.org/3/movie/popular?api_key="+BuildConfig.ApiKey;
    public static final String top_rated_url="https://api.themoviedb.org/3/movie/top_rated?api_key="+BuildConfig.ApiKey;
